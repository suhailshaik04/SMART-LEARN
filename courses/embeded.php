...
<html>
    <head>
        ...
        <title>SMART LEARN -Embedded Systems</title>
        <style>
            b
            {
                color:aqua;
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/ems.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                ...
                <div class="col-md-4 videos wow fadeInDown animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/ems1.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/ems2.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/ems3.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>AVR MicroController</h3>
                        <p>
                            <a href = "#" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
