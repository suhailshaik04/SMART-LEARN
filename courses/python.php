...
<html>
    <head>
        ...
        <title>SMART LEARN - Python</title>
        <style>
            b
            {
                color:aqua;
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/python2.png" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Python Basics</h3>
                        <p>
                ...
                <div class="col-md-4 videos wow fadeInDown animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/python4.png" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/django.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Django</h3>
                        <p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/game.png" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                ...
                <div class="col-md-4 videos  wow fadeInDown animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/gui.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/machine.png" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
