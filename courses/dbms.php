        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/DBMS.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Introduction</h3>
                        <p>
                           <a href = "https://www.youtube.com/watch?v=1057YmExS-I&list=PLEbnTDJUr_Ic_9b4PcKmlae41cyxEefot&index=1" class = "btn btn-success play" role = "button">
                              Play
                           </a> 
                ...
                <div class="col-md-4 videos wow fadeInDown animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/DBMS2.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Entity Relationship Model</h3>
                        <p>
                            <a href = "https://www.youtube.com/watch?v=gbVev8RuZLg&list=PLxCzCOWd7aiFAN6I8CuViBuCdJgiOkT2Y&index=14" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                     ...
                     <div class = "caption">
                        <h3>Relational Model & Relational Algebra</h3>
                        <p>
                            <a href = "https://www.youtube.com/watch?v=4YilEjkNPrQ&list=PLxCzCOWd7aiFAN6I8CuViBuCdJgiOkT2Y&index=43" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                     ...
                     <div class = "caption">
                        <h3>Functional Dependencies & Normalisation</h3>
                        <p>
                            <a href = "https://www.youtube.com/playlist?list=PLmXKhU9FNesR1rSES7oLdJaNFgmuj0SYV" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
                ...
                <div class="col-md-4 videos  wow fadeInDown animated caption">
                    <div class = "thumbnail">
                     ...
                     <div class = "caption">
                        ...
                        <p>
                            <a href = "https://www.youtube.com/watch?v=quz6gV7oDFI&list=PLmXKhU9FNesR1rSES7oLdJaNFgmuj0SYV&index=78" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                     ...
                     <div class = "caption">
                        <h3>SQL</h3>
                        <p>
                            <a href = "https://www.youtube.com/playlist?list=PLxCzCOWd7aiHqU4HKL7-SITyuSIcD93id" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
