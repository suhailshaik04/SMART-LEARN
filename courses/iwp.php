        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/10.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Introduction</h3>
                        <p>
                ...
                <div class="col-md-4 videos wow fadeInDown animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/IWP2.png" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/iwp5.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 videos  wow fadeInDown animated caption">
                    <div class = "thumbnail">
                     ...
                     <div class = "caption">
                        <h3>Networks, HTTP, and Servers</h3>
                        <p>
                            <a href = "#" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                     ...
                     <div class = "caption">
                        <h3>Web Applications, Front End Libraries and Frameworks</h3>
                        <p>
                            <a href = "#" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
