...
<html>
    <head>
        ...
        <title>SMART LEARN - Material Science and Engineering</title>
        <style>
            b
            {
                color:aqua;
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/mse3.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                ...
                <div class="col-md-4 videos wow fadeInDown animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/mse2.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/mse1.png" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Materials Synthesis and Processing</h3>
                        <p>
                            <a href = "#" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                     ...
                     <div class = "caption">
                        <h3>Polymers and Soft Matter</h3>
                        <p>
                            <a href = "#" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
