...
<html>
    <head>
        ...
        <title>SMART LEARN - Spintronics</title>
        <style>
            b
            {
                color:aqua;
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/sp1.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Lanthanoid Atom</h3>
                        <p>
                ...
                <div class="col-md-4 videos wow fadeInDown animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/sp2.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Graphene</h3>
                        <p>
                ...
                <div class="col-md-4 videos wow fadeInRight animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/sp3.jpeg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Behavior as Electrode</h3>
                        <p>
                            <a href = "#" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 videos wow fadeInLeft animated caption">
                    <div class = "thumbnail">
                     ...
                     <div class = "caption">
                        <h3>Magnetism & Magnetic Property</h3>
                        <p>
                            <a href = "#" class = "btn btn-success play" role = "button">
                                Play
                             </a> 
                ...
                <div class="col-md-4 videos  wow fadeInDown animated caption">
                    <div class = "thumbnail">
                        <img src = "../images/spintronic.jpg" alt = "Generic placeholder thumbnail">
                     </div>
                     <div class = "caption">
                        <h3>Nanomaterial</h3>
                        <p>
