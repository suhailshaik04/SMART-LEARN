            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse" id="menu">
                    <ul class="nav navbar-nav pull-right wow fadeInRight animated caption">
                        ...
                        <li class="nav-item"><a class="nav-link" href="LoginPage.php">Courses</a></li>
                        <li class="nav-item"><a class="nav-link" href="LoginPage.php">Quizs</a></li>
                        <li class="nav-item"><a class="nav-link" href="#faq">FAQ's</a></li>
                        <li class="nav-item"><a href="LoginPage.php" type="button" class="btn btn-success">APPLY NOW</a></li>
                    </ul>
                </div>
            </div>
        </nav>
